...
const TopTradesByVolume = () => {
	...
	const { data, loading, error } = useCachedApiCall(
		`${import.meta.env.VITE_API_URL}/api/metrics/option-volumes/${asset.toLowerCase()}`,
		{ timeRange, exchange },
		optionsCache,
		CACHE_TTL.MEDIUM,
	);
	...
	// Export hook
	const handleDownload = useChartExport(chartInstanceRef, asset, `top_options_by_volume_${asset}.png`);
	...
	const tooltipContent = `
        <div style="font-family: Inter, system-ui, Avenir, Helvetica, Arial, sans-serif; padding: 10px;">
            ...
            <div style="margin-left: 10px; margin-bottom: 10px;">
                ...
                <div style="margin-bottom: 5px;">• Height shows total USD volume traded</div>
            </div>

            <div style="margin-top: 10px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.1);">
                <b>Trading Insights:</b>
                <div style="margin-top: 5px;">• High volume indicates strong market interest</div>
                <div>• Popular contracts often have better liquidity</div>
